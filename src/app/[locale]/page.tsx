          ...
          <div className="grid">
            ...
            >
              ...
              <div className="opening-prose max-w-[56ch] font-body text-[clamp(1.08rem,1.25vw,1.18rem)] leading-[1.72] text-ink [&_p]:m-0 [&_p]:mb-[1.15em] [&_p:last-child]:mb-0 [&_em]:text-brass-2 [&_em]:italic">
                <p className="lead">
                  <span lang="en">
                    Every business is a small collection of disciplines — sales,
                    operations, customer support, employee performance,
                    marketing — each with its own tempo and its own quiet logic.
                    We build maisons that operate them as a single instrument: a
                    small team of specialist agents, one per discipline, each
                    shaped around the way the principal already runs that part
                    of the company.
                  </span>
                  <span lang="zh">
                    每一門生意都是若干領域的集合 —
                    銷售、營運、客戶支援、員工表現、行銷 —
                    各有自己的節奏，各有自己安靜的邏輯。我們打造的工坊把這些領域當作一具樂器來操作：一支小而專的代理人團隊，一個領域配一位，每一位都依照委託人原本經營該環節的方式來設計。
                  </span>
                </p>
                <p>
                  <span lang="en">
                    The Playbook is where each engagement begins. We sit with
                    the operator and write down the SOPs that already live in
                    their head — how a lead is qualified, how a delivery is
                    sequenced, how a difficult support ticket is handled, how a
                    quarter is closed. Each play is then commissioned to an
                    agent equipped with the skills that play requires: research,
                    drafting, retrieval, scheduling, dispatch. The agent runs
                    the play as the principal would have run it, and reports
                    back.
                  </span>
                  <span lang="zh">
                    每次合作的起點是
                    Playbook。我們與委託人並坐，把原本只在他腦中存在的 SOP
                    一一寫下 —
                    如何篩選一位潛在客戶、如何安排一次交付、如何處理一張棘手的支援工單、如何收結一個季度。每一道流程隨後委託給一位具備所需技能的代理人：研究、撰寫、檢索、排程、發送。代理人以委託人原本的方式執行流程，並回報結果。
                  </span>
                </p>
                <p>
                  <span lang="en">
                    What this produces, day to day, is fewer fires and a
                    steadier feed of insight. Sales activity is tracked and
                    summarised without anyone chasing a CRM. Employee
                    performance is read against the work itself, not the hours
                    logged. Operations move on their own. Customer
                    correspondence is answered in the maison&apos;s voice within
                    the hour. Marketing goes out on schedule.{' '}
                    <em>
                      The principal stops being the bottleneck and starts being
                      the architect
                    </em>{' '}
                    — which is, after all, the part of the work they wanted to
                    do in the first place.
                  </span>
                  <span lang="zh">
                    日復一日，所換來的是更少的救火，與更穩定的洞察流。銷售動態不再靠人追著
                    CRM
                    整理。員工表現是依工作本身評讀，不是依工時。營運自行運轉。客戶往來在一小時內以工坊的語氣回覆。行銷如期送出。
                    <em>委託人不再是瓶頸，而成為設計者</em> —
                    那本來就是他想做的部分。
                  </span>
                </p>
              </div>
            ...
            <Link className="plate" href={localePath(locale, '/services/ai')}>
              ...
              <div className="plate-text">
                ...
                <h3 className="plate-h3">
                  <span lang="en">
                    Intelligence, made <em>resident</em>.
                  </span>
                  <span lang="zh">
                    讓智慧 · <em>駐於業務之中</em>。
                  </span>
                ...
                <p className="plate-lede">
                  <span lang="en">
                    We embed inside the business and build the AI that ought to
                    already exist there — agents, internal tools, custom
                    evaluations, and the operating habits to keep them useful
                    long past the demo.
                  </span>
                  <span lang="zh">
                    我們進駐業務之中，打造那些本應存在的 AI —
                    代理人、內部工具、訂製評估，以及讓它們在展示之後仍然有用的操作習慣。
                  </span>
                </p>
                <ul className="plate-ref">
                  <li>
                    <span lang="en">Agentic systems &amp; internal tools</span>
                    <span lang="zh">代理系統與內部工具</span>
                  </li>
                  <li>
                    <span lang="en">
                      Custom evaluations &amp; observability
                    </span>
                    <span lang="zh">訂製評估與可觀察性</span>
                  </li>
                  <li>
                    <span lang="en">Workflow redesign for AI-native ops</span>
                    <span lang="zh">為 AI 原生運營重新設計流程</span>
                  </li>
                  <li>
                    <span lang="en">
                      Quarterly retainer or fixed engagement
                    </span>
                    <span lang="zh">季度顧問或定額合作</span>
                  </li>
                </ul>
            ...
            <Link className="plate" href={localePath(locale, '/services/digital')}>
              <div className="plate-image">
                <div className="plate-head">
                  <span>
                    <span lang="en">
                      <b>Plate III</b> — Digital Practice
                    </span>
                    <span lang="zh">
                      <b>圖版 III</b> — 數位實踐
                    </span>
              ...
              <div className="plate-text">
                ...
                <h3 className="plate-h3">
                  <span lang="en">
                    Sites built like <em>buildings</em>.
                  </span>
                  <span lang="zh">
                    如<em>建築</em>般打造的網站。
                  </span>
                ...
                <p className="plate-lede">
                  <span lang="en">
                    Bespoke web work for brands that want their digital presence
                    to read with the same confidence as their best print.
                    Designed in-house, written with intent, built to last past a
                ...
                <ul className="plate-ref">
                  <li>
                    <span lang="en">Brand &amp; identity systems</span>
                    <span lang="zh">品牌與識別系統</span>
                  </li>
                  <li>
                    <span lang="en">Site design, build &amp; CMS</span>
                    <span lang="zh">網站設計、建置與 CMS</span>
                  </li>
                  <li>
                    <span lang="en">Bespoke applications &amp; portals</span>
                    <span lang="zh">訂製應用程式與入口網站</span>
                  </li>
                  <li>
                    <span lang="en">Fixed-scope or studio retainer</span>
                    <span lang="zh">定範圍或工坊顧問</span>
                  </li>
                </ul>
                <span className="plate-more">
